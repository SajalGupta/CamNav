...
import com.example.sajal.camnav.R;
...
public class LocalDataSource extends DataSource {
    ...
    private List<Marker> fromMapActivity;
    ...
    public List<Marker> getMarkers() {
        Marker atl = new IconMarker("ATL ICON", 28.5105088, 77.0888606, 0, Color.DKGRAY, icon);
        cachedMarkers.add(atl);

        Marker home = new Marker("First Turn", 28.5100122, 77.0883816, 0, Color.YELLOW);
        cachedMarkers.add(home);

        Marker zz = new Marker("Second Turn",28.5097487,77.0887201,0,Color.RED);
        cachedMarkers.add(zz);
